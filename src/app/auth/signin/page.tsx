...
export default function SignInPage() {
  const [email, setEmail] = useState("teste@lexai.com.br");
  ...
  function handleGoogleLogin() {
    ...
    // Simula autenticação com o Google e redireciona direto
    setTimeout(() => {
      window.location.href = "/dashboard";
    }, 1200);
  }
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 bg-slate-800/80 border border-slate-700/80 rounded-2xl p-6 shadow-xl backdrop-blur-sm">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-bold text-white text-sm">Credenciais para Acesso de Teste:</h3>
          </div>
          <div className="space-y-1.5 text-xs font-mono text-slate-300 bg-slate-950/60 p-3 rounded-xl border border-slate-800">
            <p><span className="text-slate-500">Email:</span> teste@lexai.com.br</p>
            <p><span className="text-slate-500">Senha:</span> 12345678</p>
          </div>
          <p className="text-[11px] text-slate-400 mt-2">
            ⚠️ <strong>Segurança:</strong> 3 erros consecutivos de senha bloqueiam a conta por 1 hora.
          </p>
        </div>
      </div>
